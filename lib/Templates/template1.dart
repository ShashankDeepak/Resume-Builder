// ignore_for_file: prefer_const_constructors, use_key_in_widget_constructors, must_be_immutable, avoid_unnecessary_containers, prefer_const_literals_to_create_immutables
...
class Template1 extends StatelessWidget {
  //This file controls the Template 1
  //It takes the list of texts in the controller from build_resume and the image selected by the user
  PickedFile? imgFile;
  List controllers;

  Template1(this.controllers, this.imgFile);
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    "assets/Template_1.jpeg"), //The background is taken as a template which is present in the asset folder
                fit: BoxFit.fill,
              ),
            ),
          ),
